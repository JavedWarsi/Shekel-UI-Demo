      ...
      >
        ...
        <PartnerMarquee 
          ...
          partners={[
            ...
            { src: "/section-1-marketplace/logo-google-ai.png", name: "Google AI", w: 134, h: 73 },
            { src: "/section-1-marketplace/logo-anthropic.svg", name: "Anthropic", w: 185, h: 123 },
            { src: "/section-1-marketplace/logo-azure.png", name: "Azure", w: 90, h: 26 },
            { src: "/section-1-marketplace/logo-meta.png", name: "Meta", w: 95, h: 19 },
            { src: "/section-1-marketplace/logo-notion.png", name: "Notion", w: 102, h: 72 },
            { src: "/section-1-marketplace/logo-slack.png", name: "Slack", w: 103, h: 42 },
            { src: "/section-1-marketplace/logo-aws.png", name: "AWS", w: 50, h: 50 },
          ]}
        />
      </div>
    </section>
...
function HeroMobile() {
  ...
  const partnerImages = [
    ...
    { src: "/section-1-marketplace/logo-anthropic.svg", alt: "Anthropic", w: 118, h: 78 },
              ...
              <div key={copyIdx} className="flex items-center gap-8 px-4">
                {partnerImages.map((p, i) => (
                  <Float
                    ...
                    duration={3 + (i % 2)}
                  >
                    <Image src={p.src} alt={p.alt} width={p.w * 0.8} height={p.h * 0.8} className="object-contain" />
                  </Float>
                ))}
              </div>
            ))}
