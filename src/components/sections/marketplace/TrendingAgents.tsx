  ...
  return (
    <div className="absolute flex items-end justify-between" style={{ left: 52, top: 50, width: 1184, paddingBottom: 32 }}>
      ...
      <Reveal delay={0.2} className="flex items-center gap-2">
        <Link href="/marketplace" className="group flex items-center gap-2 transition-[opacity,filter] duration-200 ease-out hover:opacity-100 hover:[filter:drop-shadow(0_4px_10px_rgba(40,100,228,0.34))]">
          <span
            style={{
              fontFamily: typography.fonts.inter,
              fontWeight: 400,
