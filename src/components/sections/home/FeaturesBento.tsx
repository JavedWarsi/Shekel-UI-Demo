        ...
        <div className="absolute" style={{ left: 28, top: 79, width: 1216, height: 596 }}>
          ...
          >
            <div className="relative flex flex-col gap-4">
              ...
              <Link href="/marketplace" className="group mt-2 inline-flex items-center gap-2 transition-[transform,opacity,filter] duration-200 ease-out hover:translate-x-1 hover:opacity-100 hover:[filter:drop-shadow(0_4px_10px_rgba(40,100,228,0.34))_brightness(1.15)]">
                <span
...
function MobileCard({
  ...
  return (
    ...
    >
      ...
      {cta ? (
        <Link href="/marketplace" className="group mt-1 inline-flex items-center gap-2 transition-[transform,opacity,filter] duration-200 ease-out hover:translate-x-1 hover:opacity-100 hover:[filter:drop-shadow(0_4px_10px_rgba(40,100,228,0.34))_brightness(1.15)]">
          <span
            className="transition-[color] duration-200 ease-out group-hover:[background-image:linear-gradient(to_bottom,_#2864e4,_#ecf2ff)] group-hover:bg-clip-text group-hover:text-transparent group-hover:[-webkit-text-fill-color:transparent]"
            style={exploreLinkStyle}
          >
