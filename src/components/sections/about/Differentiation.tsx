  ...
  return (
    <section className="relative overflow-hidden bg-black px-6 py-20 md:px-16">
      ...
      <div className="relative mx-auto max-w-[1024px]">
        <h2 className="text-center" style={{ margin: 0, fontFamily: typography.fonts.poppins, fontWeight: 500, fontSize: "clamp(34px,5vw,48px)", lineHeight: "40px", color: "#fff" }}>
          Built as a system, not a tool.
        </h2>
        <div className="mt-16 grid overflow-hidden border bg-white/95 md:grid-cols-2" style={{ borderRadius: radiuses.pill, borderColor: "rgba(65,71,83,0.1)" }}>
          <ListBlock title="Standard AI Tools" icon="/section-4-about/diff-cross.svg" items={LEFT} accent="#414753" />
          <ListBlock title="Shekel Ecosystem" icon="/section-4-about/diff-check.svg" items={RIGHT} accent="#005ab6" />
        </div>
      </div>
    </section>
  );
