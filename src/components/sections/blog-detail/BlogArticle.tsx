...
export default function BlogArticle({ post }: BlogArticleProps) {
  return (
    <article className="w-full pt-32 pb-24" style={{ fontFamily: typography.fonts.inter }}>
      <div className="mx-auto max-w-[800px] px-6">
        <motion.div 
          ...
          className="mb-12"
        >
          <Link href="/blog" className="inline-flex items-center gap-2 text-[14px] font-semibold text-[#475569] hover:text-[#2864e4] mb-8 transition-colors">
          ...
          <h1 className="text-[36px] md:text-[48px] font-bold leading-[1.15] text-[#0b0b0b] mb-8" style={{ fontFamily: typography.fonts.poppins }}>
            {post.title}
          </h1>
          
          <div className="flex items-center justify-between border-y border-[rgba(0,0,0,0.06)] py-6">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-full overflow-hidden relative">
                <Image src={`https://i.pravatar.cc/150?u=${post.author}`} alt={post.author} fill className="object-cover" />
              </div>
              <div>
                <p className="text-[15px] font-bold text-[#1a1c1c]">{post.author}</p>
            ...
            <button className="w-10 h-10 rounded-full border border-[rgba(0,0,0,0.08)] flex items-center justify-center hover:bg-gray-50 transition-colors">
        ...
        >
          ...
          <h2 className="text-[28px] font-bold text-[#0b0b0b] mt-12 mb-6" style={{ fontFamily: typography.fonts.poppins }}>The Rise of Agentic Workflows</h2>
          <p className="mb-6">
          ...
          <blockquote className="border-l-4 border-[#2864e4] pl-6 my-10 italic text-[20px] font-medium text-[#1a1c1c]">
          ...
          <h3 className="text-[22px] font-bold text-[#0b0b0b] mt-10 mb-4">Key Benefits of Decentralized Intelligence</h3>
