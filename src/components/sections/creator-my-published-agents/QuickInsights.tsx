    ...
    <div className="w-full mb-8" style={{ fontFamily: typography.fonts.inter }}>
      ...
      <div className="flex flex-col gap-4">
        ...
        <motion.div
          ...
          className="bg-white rounded-[24px] p-6 shadow-[0_4px_20px_rgb(0,0,0,0.02)] border border-[rgba(0,0,0,0.02)] flex items-center gap-4"
        >
          ...
          <div className="flex flex-col">
            ...
            <p className="text-[14px] font-bold text-[#0b0b0b]">Marketing</p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="flex flex-col">
            ...
            <p className="text-[14px] font-bold text-[#0b0b0b]">Automation Agents</p>
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          className="bg-[#F8FAFC] rounded-[24px] p-6 border border-[#E2E8F0] flex items-center justify-between cursor-pointer hover:bg-[#F1F5F9] transition-colors"
        >
          <div className="flex flex-col">
