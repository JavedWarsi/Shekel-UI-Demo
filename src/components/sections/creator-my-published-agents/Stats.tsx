  ...
  return (
    <div className="w-full" style={{ fontFamily: typography.fonts.inter }}>
      <motion.div
        ...
        className="bg-white rounded-[32px] dark:bg-slate-900/70 backdrop-blur-sm p-8 md:p-10 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-[rgba(0,0,0,0.02)]"
      >
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="flex flex-col h-full">
            ...
            <div>
              ...
              <div className="flex items-baseline gap-2">
                <span className="text-[36px] font-bold dark:text-[#FFFFFF] text-[#0b0b0b] leading-none tracking-tight" style={{ fontFamily: typography.fonts.poppins }}>12</span>
          ...
          <div className="flex flex-col h-full">
            ...
            <div>
              ...
              <div className="flex items-baseline gap-2">
                <span className="text-[36px] font-bold dark:text-[#FFFFFF] text-[#0b0b0b] leading-none tracking-tight" style={{ fontFamily: typography.fonts.poppins }}>8,420</span>
          ...
          <div className="flex flex-col h-full">
            ...
            <div>
              ...
              <div className="flex items-baseline gap-2">
                <span className="text-[36px] font-bold dark:text-[#FFFFFF] text-[#0b0b0b] leading-none tracking-tight" style={{ fontFamily: typography.fonts.poppins }}>$6,280</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col h-full">
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                <span className="text-[36px] font-bold dark:text-[#FFFFFF] text-[#0b0b0b] leading-none tracking-tight" style={{ fontFamily: typography.fonts.poppins }}>4.7</span>
