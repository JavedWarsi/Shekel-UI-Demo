...
export default function CreatorSuggestion() {
  return (
    <motion.div
      ...
      className="bg-white rounded-[32px] p-8 shadow-[0_4px_20px_rgb(0,0,0,0.02)] border border-[rgba(0,0,0,0.02)] w-full"
    ...
    >
      ...
      <p className="text-[14px] text-[#0b0b0b] leading-[1.6] mb-8">
