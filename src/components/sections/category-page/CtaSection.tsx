...
function PrimaryButton({ width, height }: { width?: number | string; height?: number | string }) {
  return (
    <button
      className="
    flex items-center justify-center shrink-0 cursor-pointer border-none
    transition-all duration-300 ease-in-out
    hover:scale-105 hover:shadow-[0px_10px_30px_rgba(40,100,228,0.35)]
    active:scale-95
  "
      style={{
        width: width || "auto",
...
function SecondaryButton({ width, height }: { width?: number | string; height?: number | string }) {
  return (
    <button
      className="flex items-center justify-center transition-all duration-300 ease-in-out shrink-0 cursor-pointer bg-white hover:shadow-[0px_10px_30px_rgba(40,100,228,0.35)]"
      style={{
        width: width || "auto",
        height: height || "auto",
        padding: "21px 41px",
...
function SectionDesktop() {
  return (
    <section
      className="relative hidden w-full dark:bg-[#0C0C0E] overflow-hidden md:block py-16"
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <div className="rocket-3d-wrapper">
              <Image
                src="/section-2-faq/rocketfaq.png"
                alt="Rocket"
                fill
                unoptimized
                className="object-contain scale-[1.60] rocket-3d"
              />
            </div>
          </div> */}
          ...
          >
            ...
            {/* rocker */}
            <div className="relative rocket-3d-wrapper z-20 w-full ] ml-[350px] aspect-square flex items-center justify-center mt-8">
                        <Image
                          src="/section-2-faq/rocketfaq.png"
                          ...
                          className="object-contain scale-[1.4] animate-float"
                          priority
                          unoptimized
                        />
                      </div>
