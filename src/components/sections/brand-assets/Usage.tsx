        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          >
            <div className="flex items-center gap-3 mb-2">
              ...
              <h2 className="text-[36px] font-medium text-[#8BA8FF]" style={{ fontFamily: typography.fonts.poppins }}>
                Usage Dos
              </h2>
            </div>
            ...
            <div className="flex flex-col gap-4">
              {DOS.map((item, i) => (
                <div 
                  key={i} 
                  className="flex items-start gap-4 p-6 rounded-[20px] bg-[#F8FFF9] border border-[#E2F5E9]"
                >
                  ...
                  <div className="flex flex-col gap-1">
                    <h3 className="text-[16px] font-bold text-[#1A202C]" style={{ fontFamily: typography.fonts.inter }}>
                      {item.title}
                    </h3>
          ...
          >
            <div className="flex items-center gap-3 mb-2">
              ...
              <h2 className="text-[36px] font-medium text-[#FF6B6B]" style={{ fontFamily: typography.fonts.poppins }}>
                Usage Don'ts
              </h2>
            </div>
            ...
            <div className="flex flex-col gap-4">
              {DONTS.map((item, i) => (
                <div 
                  key={i} 
                  className="flex items-start gap-4 p-6 rounded-[20px] bg-[#FFF8F8] border border-[#FFEAEA]"
                >
