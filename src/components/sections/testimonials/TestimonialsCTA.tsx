  ...
  return (
    <section className="relative hidden w-full overflow-visible md:block mb-30" style={{ aspectRatio: `${CANVAS_W}/${CANVAS_H}`, containerType: "inline-size" }}>
          <div className="absolute left-0 top-0 overflow-visible" style={{ width: CANVAS_W, height: CANVAS_H, transform: `scale(${SCALE})`, transformOrigin: "top left" }}>
            ...
            <Image
              src="/section-15-testimonials/testimobotlap.png"
              alt=""
              width={960}
              height={1020}
              className="pointer-events-none absolute top-[15%] z-20 scale-x-[-1] -ml-[20%] animate-[bounce_5s_ease-in-out_infinite]"
      ...
      return (
        <section className="mx-4 rounded-2xl p-6 md:hidden" style={{ backgroundImage: "url('/section-7-create-ai-agent-page/cta-bg.png')", backgroundSize: "cover", backgroundPosition: "center" }}>
          ...
          <div className="mt-4 grid gap-2">
            <button className="rounded-xl py-3 text-sm uppercase tracking-[1.4px] text-white" style={{ background: 'blue' }}>Publish Agent</button>
