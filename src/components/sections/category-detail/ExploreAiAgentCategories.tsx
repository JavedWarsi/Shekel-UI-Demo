      ...
      >
        ...
        <PartnerMarquee 
          ...
          partners={[
            ...
            { src: "/section-1-category-detail/logo-google.png", name: "Google AI", w: 134, h: 73 },
            { src: "/section-1-category-detail/logo-anthropic.svg", name: "Anthropic", w: 185, h: 123 },
            { src: "/section-1-category-detail/logo-azure.png", name: "Azure", w: 90, h: 26 },
            { src: "/section-1-category-detail/logo-meta.png", name: "Meta", w: 102, h: 72 },
            { src: "/section-1-category-detail/ellipse-2.png", name: "Partner 1", w: 103, h: 28 },
            { src: "/section-1-category-detail/ellipse-3.png", name: "Partner 2", w: 134, h: 73 },
            { src: "/section-1-category-detail/ellipse-1.png", name: "Partner 3", w: 50, h: 50 },
          ]}
        />
      </div>
    </section>
        ...
        >
          {[0, 1].map((copyIdx) => (
            <div key={copyIdx} className="flex items-center gap-12 px-6">
              {[
                { src: "/section-1-category-detail/ellipse-2.png", alt: "Partner", w: 80, h: 22 },
                { src: "/section-1-category-detail/ellipse-3.png", alt: "Partner", w: 100, h: 55 },
                { src: "/section-1-category-detail/logo-anthropic.svg", alt: "Anthropic", w: 140, h: 93 },
                { src: "/section-1-category-detail/logo-meta.png", alt: "Meta", w: 80, h: 56 },
                { src: "/section-1-category-detail/logo-openai.png", alt: "OpenAI", w: 70, h: 20 },
                { src: "/section-1-category-detail/logo-google.png", alt: "Google AI", w: 75, h: 15 },
                { src: "/section-1-category-detail/logo-azure.png", alt: "Azure", w: 80, h: 33 },
                { src: "/section-1-category-detail/ellipse-1.png", alt: "Partner", w: 40, h: 40 },
              ].map((p, i) => (
                <Float key={`${copyIdx}-${i}`} motion3d amplitude={2} duration={3 + (i % 2)}>
                  <Image src={p.src} alt={p.alt} width={p.w} height={p.h} className="h-auto w-auto object-contain" />
                </Float>
              ))}
            </div>
          ))}
