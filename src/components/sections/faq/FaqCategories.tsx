        ...
        <div className="relative p-8 md:p-16 rounded-[40px] bg-slate-50 dark:bg-zinc-900/50 border border-slate-200 dark:border-white/5 overflow-hidden shadow-sm">
           <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-8">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <button className="px-8 py-4 rounded-2xl bg-white dark:bg-black/50 border border-slate-200 dark:border-white/10 font-bold text-slate-900 dark:text-white shadow-sm hover:bg-slate-50 dark:hover:bg-white/5 transition-all">
                  Contact Support
                </button>
                <button className="px-8 py-4 rounded-2xl bg-gradient-to-br from-blue-500 to-blue-400 text-white font-bold shadow-lg shadow-blue-500/25 flex items-center gap-3 hover:opacity-90 transition-all">
                  <Image src={ICONS.whatsappchat} alt="WhatsApp" width={20} height={20} />
                  Chat on WhatsApp
                </button>
              </div>
           </div>
