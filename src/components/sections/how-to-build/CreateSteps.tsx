        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {STEPS.map((step, i) => (
            <motion.div
              ...
              className="bg-white rounded-[24px] p-8 border border-[#E2E8F0] shadow-sm flex flex-col items-start h-full"
            >
              <div className="w-10 h-10 rounded-full bg-[#2864E4] flex items-center justify-center text-white font-bold text-[16px] mb-8">
                {step.num}
              </div>
