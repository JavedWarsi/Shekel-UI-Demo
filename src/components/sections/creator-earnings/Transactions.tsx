...
const TRANSACTIONS = [
  {
    ...
    amount: "$120.00",
    status: "Completed",
    statusColor: "bg-[#D1FAE5] dark:bg-green-900/30 text-[#10B981]",
    icon: FileText,
  ...
  },
  {
    ...
    amount: "$45.50",
    status: "Processing",
    statusColor: "bg-[#F1F5F9] dark:bg-slate-800 text-[#64748B] dark:text-slate-400",
    icon: Paintbrush,
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-gray-200 dark:bg-slate-800">
              <th className="py-4 px-8 md:px-10 text-[10px] font-medium text-[#64748B] dark:text-slate-400 uppercase tracking-wider whitespace-nowrap">Agent / Product</th>
              <th className="py-4 px-4 text-[10px] font-medium text-[#64748B] dark:text-slate-400 uppercase tracking-wider whitespace-nowrap">Date</th>
              <th className="py-4 px-4 text-[10px] font-medium text-[#64748B] dark:text-slate-400 uppercase tracking-wider whitespace-nowrap">Amount</th>
              <th className="py-4 px-8 md:px-10 text-[10px] font-medium text-[#64748B] dark:text-slate-400 uppercase tracking-wider whitespace-nowrap">Status</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-[rgba(0,0,0,0.04)] dark:divide-slate-800">
                ...
                <td className="py-5 px-8 md:px-10">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-[11px] text-[#64748B] dark:text-slate-400 mt-0.5">
                        {tx.desc}
                      </span>
                    </div>
                  </div>
                </td>
                <td className="py-5 px-4 text-[13px] text-[#475569] dark:text-slate-400">
                  {tx.date}
                </td>
                <td className="py-5 px-4 text-[14px] font-medium text-[#0b0b0b] dark:text-white">
                  {tx.amount}
                </td>
                <td className="py-5 px-8 md:px-10">
