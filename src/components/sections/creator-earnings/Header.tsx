    ...
    <div className="w-full flex flex-col mb-10" style={{ fontFamily: typography.fonts.inter }}>
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          <button className="flex items-center gap-2 bg-white border border-[#E2E8F0] text-[#0b0b0b] px-4 py-2.5 rounded-[12px] font-medium text-[13px] hover:bg-gray-50 transition-colors shadow-sm">
          ...
          <button className="flex items-center gap-2 bg-[#0550E6] text-white px-5 py-2.5 rounded-[12px] font-medium text-[13px] hover:bg-[#0440C5] transition-colors shadow-[0_4px_14px_rgba(5,80,230,0.25)]">
