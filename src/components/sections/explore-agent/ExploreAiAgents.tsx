        ...
        >
          ...
          <div className="absolute flex flex-col" style={{ left: 32, top: 69.88, width: 512, gap: 32 }}>
            ...
            <div className="flex flex-row gap-4 pt-4">
              <Link href="/marketplace"><PrimaryButton /></Link>
              <a href="https://docs.shekel.ai" target="_blank" rel="noopener noreferrer"><SecondaryButton /></a>
            </div>
          </div>
    ...
    >
      <div className="flex flex-col gap-8 px-6 py-16 relative z-10">
        ...
        <div className="flex flex-col gap-4">
          <Link href="/marketplace" className="w-full"><PrimaryButton fullWidth /></Link>
          <a href="https://docs.shekel.ai" target="_blank" rel="noopener noreferrer" className="w-full"><SecondaryButton fullWidth /></a>
        </div>
