      ...
      >
        ...
        >
          <div className="flex flex-row justify-between items-center w-full">
            ...
            <Link href="/marketplace" className="flex flex-row items-center gap-1 cursor-pointer hover:opacity-80 transition-opacity">
              <span
                style={{
                  fontFamily: typography.fonts.inter,
                  fontWeight: 600,
    ...
    <section className="relative block w-full md:hidden">
      <div className="flex flex-col gap-8 px-6 py-16">
        ...
        <div className="flex flex-col gap-6 mt-8">
          ...
          <Link href="/marketplace" className="flex flex-row items-center justify-center gap-1 mt-4 hover:opacity-80 transition-opacity">
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-start h-full w-full">
        ...
        <Link href="/marketplace" className={`flex flex-row items-center justify-center mt-auto ${mobile ? "w-full" : ""}`}>
          <button
            className={`flex flex-row items-center justify-center ${mobile ? "w-full" : ""}`}
            style={{
              background: btnBg,
              borderRadius: 9999,
              padding: "10px 24px",
